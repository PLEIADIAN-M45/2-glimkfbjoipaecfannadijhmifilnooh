...
define(["app.router"], function($router) {
    ...
    var $name = "OBSApp",
        ...
        components = { "edit": ['edit', 'dialog'], "logs": ['cards'] } [$module],
        stylesheet = { "edit": ['edit'], "logs": ['logs', 'cards'] } [$module],
        $controller, $injector, $scope, $invoke, $compile,
...
angular.extend(this.$scope, this.__proto__)


//Object.setPrototypeOf(this.$scope, this.__proto__)
...
//var obj2 = $.extend(true, {}, this);
//console.log(obj2);


//angular.copy(this.__proto__, c)


//Object.setPrototypeOf(c, this.__proto__)
// console.log(c);
