...
(function() {
    ...
    var Ea = function(a, b, c, d) {
        ...
        Ia = function(a) { var b = Ga; if(!Fa()) try { b() } catch (c) {} Ha(a) },
        Ha = function(a) {
            if(Fa()) a();
            else {
                var b = !1,
    ...
    H.push(["jsl", function(a) {
        for(var b in a)
            if(x(a, b)) { var c = a[b]; "object" == typeof c ? F[b] = v(F, b, []).concat(c) : v(F, b, c) } if(b = a.u) a = v(F, "us", []), a.push(b), (b = /^https:(.*)$/.exec(b)) && a.push("http:" + b[1])
    }]);
    var Xa = /^(\/[a-zA-Z0-9_\-]+)+$/,
        Ya = [/\/amp\//, /\/amp$/, /^\/amp$/],
        Za = /^[a-zA-Z0-9\-_\.,!]+$/,
    ...
    var Ab = { apppackagename: 1, callback: 1, clientid: 1, cookiepolicy: 1, openidrealm: -1, includegrantedscopes: -1, requestvisibleactions: 1, scope: 1 },
        ...
        Db = function() {
            if(!Bb) {
                ...
                if(window.self !== window.top) { a = document.location.toString(); for(var e in Ab) 0 < Ab[e] && (b = C(a, e, "")) && (Cb[e] = b) } Bb = !0
            }
            e = w();
            z(Cb, e);
            return e
    ...
    var Qb, Q, R = void 0,
        ...
        oc = function() {
            ...
            if((void 0 === Qb || void 0 === R || Q !== a) && -1 !== Q) {
                ...
                Q = -1;
                try {
                    try { R = !!m.JSON && '{"a":[3,true,"1970-01-01T00:00:00.000Z"]}' === m.JSON.stringify.call(m.JSON, { a: [3, !0, new Date(0)], c: function() {} }) && !0 === S("true") && 3 === S('[{"a":3}]')[0].a } catch (b) {} Qb = R && !S("[00]") &&
                        !S('"\u0007"') && !S('"\\0"') && !S('"\\v"')
                } finally { Q = a }
            }
        },
